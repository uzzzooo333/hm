...
$search = $_GET['search'] ?? '';
$where = $search ? "WHERE name LIKE '%$search%' OR contact LIKE '%$search%'" : '';
...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2><i class="bi bi-people"></i> Patients List</h2>
            <small class="text-muted"><?php echo $patients->num_rows; ?> patients found</small>
        </div>
        <div class="d-flex gap-2">
            <input type="text" id="searchInput" class="form-control" style="width: 300px;" placeholder="Search by name/contact...">
            <a href="add_patient.php" class="btn btn-success"><i class="bi bi-plus-lg"></i> Add Patient</a>
        </div>
    </div>
                ...
                <table class="table table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $patient['dob'] ? calculate_age($patient['dob']) . ' yrs' : '-'; ?>
                            </td>
                            ...
                            <td>
                                <div class="btn-group" role="group">
                                    <a href="book_appointment.php?patient_id=<?php echo $patient['id']; ?>" class="btn btn-sm btn-outline-primary" title="Book Appointment">
                                    ...
                                    <a href="../public/patient_portal.php?id=<?php echo $patient['id']; ?>" class="btn btn-sm btn-outline-info" title="Patient Portal" target="_blank">
...
$(document).ready(function() {
    $('#searchInput').on('keyup', function() {
        let value = $(this).val();
        window.location.href = `patients_list.php?search=${value}`;
    });
});
</script>
